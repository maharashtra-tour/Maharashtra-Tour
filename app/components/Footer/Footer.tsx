    ...
    <div className="mx-auto mb-8 max-w-2xl sm:pt-24 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
      <div className="my-4 grid grid-cols-1 gap-y-10 sm:grid-cols-6 lg:grid-cols-12">
        ...
        <div className="sm:col-span-6 lg:col-span-5">
          ...
          <h3 className="text-xs font-medium text-gunmetalgray lh-160 mt-5 mb-4 lg:mb-16">
            {" "}
            Uncover Mumbai&apos;s Ultimate Destination for Cab Service. <br />{" "}
      ...
      <div className="py-10 md:flex space-y-4 sm:space-y-0 items-center justify-between border-t border-t-gray-blue">
        <h4 className="text-dark-red opacity-75 text-sm text-center md:text-start font-normal">
          ©2024. Maharashtra Tours. All rights reserved
        </h4>
        <h4 className="text-dark-red font-normal opacity-75 text-sm text-center md:text-start">
          ©2024. Developed By{" "}
          <Link
            href="https://wa.me/918286112257?text=Hello, I just visited the Maharashtra Tours website and I'm reaching out to chat about your web design services."
            target="_blank"
            className="underline"
          >
            VSM Webmasters
        ...
        <div className="flex gap-5 mt-5 md:mt-0 justify-center md:justify-start">
          <h4 className="text-black opacity-75 text-sm font-normal">
