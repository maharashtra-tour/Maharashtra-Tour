                        ...
                        <div>
                            ...
                            <div className="my-12 grid md:grid-cols-2 grid-cols-1 md:gap-x-8 gap-y-8">
                                <div className="rounded-2xl border border-[#e5e7eb] bg-white p-7 group transition-all duration-500 ">
                                    <a href="javascript:;" className="w-14 h-14 bg-Blueviolet rounded-full flex items-center justify-center mb-5 transition-all duration-500 cursor-pointer">
                                        <svg className="fill-white transition-all duration-500 hover:text-[#9ca3af] " width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <h5 className="text-[#111827] text-xl font-semibold leading-8 mb-3 transition-all duration-500 ">Support</h5>
                                    <p className="text-gray-500 text-sm font-normal leading-5 transition-all duration-500 ">We Provide Various Methods For You To Carry Out All Transactions Related To Your Finances</p>
                                </div>
                                <div className="rounded-2xl border border-[#e5e7eb] bg-white p-7 group transition-all duration-500 ">
                                    <a href="javascript:;" className="w-14 h-14 bg-Blueviolet rounded-full flex items-center justify-center mb-5 transition-all duration-500 cursor-pointer">
                                        <svg className="stroke-white transition-all duration-500 group-hover:stroke-blubg-Blueviolet" width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <h5 className="text-[#111827] text-xl font-semibold leading-8 mb-3 transition-all duration-500 ">Pagedone Blog</h5>
                                    <p className="text-gray-500 text-sm font-normal leading-5 transition-all duration-500 ">We have the most up-to-date security to support the security of all our customers in carrying out all transactions. </p>
                                </div>
                            </div>
                            <div className="border-t border-[#e2e8f0] pt-12 flex lg:justify-start justify-center">
                                <div className="flex gap-x-1 border-r border-indigo-300 items-center">
                                    ...
                                    <a href="javascript:;" className="text-indigo-900 text-lg font-normal leading-7 pl-2.5 pr-3.5">4.9 Rating</a>
                                </div>
                                <a href="javascript:;" className="pl-3.5 text-indigo-900 text-lg font-normal leading-7">163 Reviews on <span className="text-emerald-500"> Trustpilot </span>
                                </a>
                            </div>
                        </div>
                        <form action="" className="h-fit bg-white border border-[#e2e8f0] rounded-2xl lg:p-12 p-8 w-full max-w-lg md:max-w-3xl lg:max-w-full mx-auto">
                            <div className="relative mb-4">
                                ...
                                <div className="relative text-gray-500 focus-within:text-[#111827]">
                                    ...
                                    <input type="text" id="default-search" className="w-full block h-12 pr-5 pl-12 py-2.5 text-lg leading-7 font-normal shadow-xs text-[#111827] bg-transparent border border-[#d1d5db] rounded-full placeholder-gray-400 focus:outline-none" placeholder="John Doe" />
                                </div>
                            </div>
                            <div className="relative mb-4">
                                <label className="flex  items-center mb-2 text-gray-600 text-base leading-6 font-medium">Contact No </label>
                                <div className="relative text-gray-500 focus-within:text-[#111827]">
                                    <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none ">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <input type="text" id="default-search" className="w-full block h-12 pr-5 pl-12 py-2.5 text-lg leading-7 font-normal shadow-xs text-[#111827] bg-transparent border border-[#d1d5db] rounded-full placeholder-gray-400 focus:outline-none" placeholder="+91 92929 92929" />
                                </div>
                            </div>
                            <div className="relative mb-4">
                                <label className="flex  items-center mb-2 text-gray-600 text-base leading-6 font-medium">Message </label>
                                <div className="relative ">
                                    <textarea className="block w-full h-40 px-4 py-2.5 text-lg leading-7 font-normal shadow-xs text-[#111827] bg-transparent border border-[#d1d5db] rounded-2xl placeholder-gray-400 focus:outline-none resize-none" placeholder="Write your message"></textarea>
                                </div>
                            </div>
                            <button className="w-full h-12 rounded-full bg-Blueviolet hover:bg-indigo-900 transition-all duration-700 shadow-sm text-white text-base font-semibold leading-6 flex items-center justify-center">Send message <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
