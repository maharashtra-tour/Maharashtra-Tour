...
export const metadata: Metadata = {
  title: "Mumbai Darshan Cab Service | Maharashtra Tours",
  description:
  ...
  keywords: [
    ...
    "mumbai darshan cab price",
    "mumbai darshan cab from dombivli",
    "mumbai darshan cab from panvel",
    "pune to mumbai darshan cab",
    "mumbai darshan cab rate",
    "cab for mumbai darshan from pune",
    "mumbai darshan cab package",
    "mumbai darshan cab service",
    "mumbai darshan cabs worli mumbai maharashtra",
    "book cab for mumbai darshan",
    "hire cab for mumbai darshan",
    "mumbai darshan cab charges",
    "mumbai darshan cab from badlapur",
    "mumbai darshan cab from bhiwandi",
    "mumbai darshan cab from dadar",
    "mumbai darshan cab from kalyan",
    "mumbai darshan cab from mira road",
    "mumbai darshan cab from pune",
    "mumbai darshan cab from thane",
    "mumbai darshan cab from vashi",
    "mumbai darshan cab service thane",
    "mumbai darshan cabs fare",
    "mumbai darshan cabs from kharghar",
    "mumbai darshan cabs from navi mumbai",
    "pune to mumbai darshan cab booking",
    "pune to mumbai darshan cab service",
  ],
  alternates: {
