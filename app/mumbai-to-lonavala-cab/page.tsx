...
const sections = [
  {
    ...
    content: [
      "Travel from Mumbai to Lonavala in comfort and style with Maharashtra Tours' cab services. Our well-maintained vehicles ensure a smooth journey, allowing you to enjoy the scenic drive between these two beautiful destinations.",
      ...
      "Book your Mumbai to Lonavala cab with Maharashtra Tours today and experience the ease and comfort of our reliable services. We guarantee a pleasant and memorable trip every time.",
    ],
  },
  {
    title: "Why Choose Maharashtra Tours for Your Mumbai to Lonavala Journey?",
    content: [
      "Choosing Maharashtra Tours for your Mumbai to Lonavala trip ensures a top-notch travel experience. Our cabs are equipped with modern amenities to provide the utmost comfort during your journey.",
      ...
      "Experience the difference with Maharashtra Tours. Book your cab today and enjoy a smooth, comfortable, and reliable trip from Mumbai to Lonavala.",
    ],
  },
  {
    title:
      "Explore Lonavala with Maharashtra Tours' Mumbai to Lonavala Cab Services",
    content: [
      "Lonavala, known for its lush green hills and scenic beauty, is a popular getaway from Mumbai. With Maharashtra Tours' Mumbai to Lonavala cab service, you can explore this charming hill station with ease and comfort.",
      ...
      "Don't miss the opportunity to discover Lonavala. Book your cab with Maharashtra Tours and enjoy a smooth and enjoyable journey from Mumbai to Lonavala. We are committed to providing exceptional service and ensuring your trip is unforgettable.",
    ],
  },
];
